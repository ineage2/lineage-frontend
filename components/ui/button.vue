...
<template>
    ...
    >
        ...
        <div class="button-1-decor button-1-decor-1"><span></span><span></span></div>
        <div class="button-1-decor button-1-decor-2"><span></span></div>
    </nuxt-link>
</template>

<style scoped>
.button-1 {
    @apply font-arpona-regular mx-auto flex items-center justify-center relative cursor-pointer w-64 h-12 text-base no-underline text-vlada-color-1 rounded-lg transition duration-300;
    ...
    &-decor-1 {
        ...
        span {
            ...
            &::after {
                @apply absolute left-0 right-0 top-0 bottom-0 z-20 border-[1.5rem] border-transparent duration-300;
                content: "";
    ...
    &-decor-2 {
        ...
        span {
            ...
            &::before {
                ...
                animation: button-1-animation 2s steps(75) infinite;
