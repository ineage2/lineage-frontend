...
<template>
    <header class="py-3 fixed w-full z-50 top-0 transition duration-500" :class="headerClass">
        <div class="container-inner flex justify-center">
            <ul class="flex gap-4 items-center" data-aos="fade-down" data-aos-delay="100" data-aos-duration="600" data-aos-once="true">
                <li>
